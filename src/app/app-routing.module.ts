    ...
    children: [
      {
        ...
        children: [
          ...
          { path: 'dashboard', component: DashboardComponent },
          {
            ...
            children: [{ path: 'agregar-productos', component: AgregarProductosComponent }],
          },
          {
            path: 'gestionar-productos/:tipoCarne/:corteId/editar-productos',
          ...
          { path: 'perfil/editar', component: EditComponent },
        ],
      },
    ],
  },
