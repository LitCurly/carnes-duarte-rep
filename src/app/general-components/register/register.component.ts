...
export class RegisterComponent implements OnInit {
  ...
  async register(): Promise<void> {
    ...
    const { email, password, nombre, segundoNombre, apellido, segundoApellido, rut, telefono, direccion, rol } = this.registerForm.value;
    ...
    try {
      ...
      if (error.code === 'auth/email-already-in-use') {
        this.showErrorMessage('Un usuario ya se ha registrado con ese correo electrónico. Por favor, intente con otro.');
      } else {
